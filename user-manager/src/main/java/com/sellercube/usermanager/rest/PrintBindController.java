...
public class PrintBindController {
    ...
    private Result insert(@RequestBody PrintBind printBind) throws Exception{
    ...
    private Result update(@RequestBody PrintBind printBind, @PathVariable("id")Integer id) throws Exception{
        printBind.setId(id);
