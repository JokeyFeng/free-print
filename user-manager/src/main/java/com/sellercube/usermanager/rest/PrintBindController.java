...
public class PrintBindController {
    ...
    public Result insert(@RequestBody PrintBind printBind){
    ...
    public Result update(@RequestBody PrintBind printBind,@PathVariable("id")Integer id){
        printBind.setId(id);
    ...
    @GetMapping("/printbindbycondition")
